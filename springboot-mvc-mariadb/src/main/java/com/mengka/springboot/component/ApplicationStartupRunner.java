...
public class ApplicationStartupRunner implements CommandLineRunner {
    ...
    @Autowired
    private MetaDataProcess metaDataProcess;
    ...
    public void run(String... args) throws Exception {
        ...
        List<TableColumnTypeMap> columnTypeMaps = metaDataProcess.getTableColumns("note");
        log.info("----------, "+new Gson().toJson(columnTypeMaps));
