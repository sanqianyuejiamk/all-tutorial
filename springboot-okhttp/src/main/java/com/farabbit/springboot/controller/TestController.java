...
import com.farabbit.springboot.component.OKHttpUtil;
...
public class TestController {
    ...
    public ResponseEntity<String> hello() {
        ...
        String url = "http://127.0.0.1:8071/book/t1";
        JSONObject jsonObject=new JSONObject();
        jsonObject.put("id",1);
        String result = okHttpUtil.postJsonParams(url,jsonObject.toJSONString());
