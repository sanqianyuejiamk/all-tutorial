...
public class UserPageController {
    ...
    public UserDTO selectPage2(@RequestParam(value = "id")String id) {
        ...
        // pagehelper
        PageInfo<User> info = PageHelper.startPage(2, 2).doSelectPageInfo(() -> userMapper.selectList(Wrappers.<User>lambdaQuery().eq(User::getGmtCreate, "2021-05-05 16:07:50").orderByAsc(User::getAge)));
    ...
    @RequestMapping(path = "/selectPage3", method = RequestMethod.POST)
    public UserDTO selectPage3(@RequestParam(value = "id")String id) {

        // pagehelper
        PageHelper.startPage(2, 2);
        List<User> list = userMapper.selectList(Wrappers.<User>lambdaQuery().eq(User::getGmtCreate, "2021-05-05 16:07:50").orderByAsc(User::getAge));
...
//        List<User> userList = pageInfo.getList();
        ...
        return userTransf.toDTO(list.get(0));
    }
}
